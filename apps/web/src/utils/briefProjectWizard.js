...
const TAG_SIGNAL_MAP = {
  ...
  ozonic: { letters: ['B', 'G', 'M'], functions: ['diffuser', 'modifier', 'bridge'], impact_band: 'high', life_hint: [2, 24] },
  metallic: { letters: ['G', 'L', 'M'], functions: ['modifier', 'bridge'], impact_band: 'medium', life_hint: [4, 48] },
  aldehydic: { letters: ['B', 'C', 'L'], functions: ['diffuser', 'modifier'], impact_band: 'high', life_hint: [2, 18] },
  solventy: { letters: ['B', 'G', 'L'], functions: ['modifier', 'diffuser'], impact_band: 'medium', life_hint: [2, 18] },
  cold_air: { letters: ['B', 'G', 'M'], functions: ['diffuser', 'bridge'], impact_band: 'medium', life_hint: [2, 24] },
  diffusive: { letters: ['B', 'L', 'M'], functions: ['diffuser', 'hero'], impact_band: 'high', life_hint: [2, 36] },
