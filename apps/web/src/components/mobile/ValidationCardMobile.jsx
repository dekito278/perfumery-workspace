...
const ValidationCardMobile = ({ log, formula, onOpen }) => (
  <article className="mobile-card mobile-compact-card p-3">
    ...
    <div className="mt-2 flex items-center justify-between gap-3">
      <div className="text-[11px] font-semibold text-[#9ca3af]">Due {formatDate(log.tested_at || log.created)}</div>
      <Button type="button" variant="outline" size="icon" onClick={onOpen} className="h-9 w-9 rounded-xl bg-white">
