...
const navGroups = [
  {
    ...
    paths: ['/mobile/studio/products', '/mobile/studio/orders', '/mobile/studio/customers', '/mobile/studio/bespoke', '/mobile/dashboard', '/mobile/catalog', '/mobile/cart', '/mobile/bespoke', '/mobile/products'],
    items: [
