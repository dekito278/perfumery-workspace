    ...
    <MobileAuthenticatedLayout taskMode>
      ...
      <main className="mobile-page space-y-4">
        ...
        <section className="mobile-card p-2">
          <div className="grid grid-cols-3 gap-1 rounded-2xl bg-editorial-paper p-1">
            {[
              ['new', 'Tambah'],
              ['list', 'Daftar'],
              ['categories', 'Kategori'],
              ...
              <button
                ...
                className={`h-10 rounded-xl text-[11px] font-bold transition ${activeView === view ? 'bg-white text-editorial-charcoal shadow-sm' : 'text-[#7a8377]'}`}
              >
                {label}
              </button>
            ))}
