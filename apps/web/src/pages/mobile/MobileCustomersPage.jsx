          ...
          {visibleCustomers.map((customer) => (
            <article key={customer.id || customer.customerCode} className="mobile-card mobile-list-card p-3">
              <div className="flex items-start justify-between gap-3">
                ...
                <button type="button" onClick={() => copyCode(customer)} className="mobile-interactive mobile-pressable shrink-0 rounded-2xl bg-editorial-charcoal px-3 py-2 text-xs font-bold text-editorial-ivory">
