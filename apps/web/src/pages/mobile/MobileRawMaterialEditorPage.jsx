      ...
      <main className="mobile-page space-y-4">
        ...
        <section className="mobile-soft-card p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h1 className="text-lg font-bold leading-tight text-editorial-charcoal">{isEditing ? 'Update the material record carefully.' : 'Create the material record first.'}</h1>
        ...
        <section className="mobile-card p-4">
          <div className="mb-4">
            ...
            <h2 className="text-base font-bold text-editorial-charcoal">Material basics</h2>
          </div>
        ...
        <section className="mobile-card p-4">
          <div className="mb-4">
            ...
            <h2 className="text-base font-bold text-editorial-charcoal">Inventory guardrails</h2>
          </div>
          <div className="grid gap-4">
            <div className="grid grid-cols-2 gap-3">
        ...
        <section className="mobile-card p-4">
          <div className="mb-4">
            ...
            <h2 className="text-base font-bold text-editorial-charcoal">Safety and usage hints</h2>
          </div>
          <div className="grid gap-4">
            <div className="grid grid-cols-2 gap-3">
        ...
        <section className="mobile-card p-4">
          <div className="mb-4">
            ...
            <h2 className="text-base font-bold text-editorial-charcoal">Cleanup status and notes</h2>
          </div>
          <div className="grid gap-4">
