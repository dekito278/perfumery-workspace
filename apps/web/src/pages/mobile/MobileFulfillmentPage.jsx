    ...
    <MobileAuthenticatedLayout showFab={false}>
      ...
      <main className="mobile-page space-y-4">
        ...
        <section className="mobile-studio-hero p-4">
          ...
          <div className="mt-3 rounded-2xl border border-editorial-charcoal/10 bg-white/78 p-3">
        ...
        <section className="space-y-3">
          <div className="flex items-center justify-between gap-3">
            <h2 className="text-base font-bold text-editorial-charcoal">Antrean siap</h2>
              ...
              <article key={orderKey} className="mobile-card mobile-list-card p-3">
                ...
                <div className="mt-3 grid gap-2">
                  ...
                  {getOrderVoucherSnapshot(order) ? (
                    <div className="flex items-center justify-between gap-2 rounded-2xl bg-editorial-ivory px-3 py-2">
                      <span className="min-w-0 truncate text-xs font-bold text-editorial-charcoal">Voucher {getOrderVoucherSnapshot(order).code}</span>
                      <span className="shrink-0 text-[10px] font-bold text-editorial-charcoal">-{formatTotal(getOrderVoucherSnapshot(order).discountAmount)}</span>
                    </div>
                  ) : null}
                </div>
                ...
                <div className="mt-3 flex items-center justify-between gap-3">
                  <div>
                    ...
                    {getOrderVoucherSnapshot(order) ? <div className="text-[11px] font-bold text-editorial-charcoal">Hemat {formatTotal(getOrderVoucherSnapshot(order).discountAmount)}</div> : null}
                  </div>
                  <Button
                    type="button"
                    variant="ghost"
