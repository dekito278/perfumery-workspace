...
const ValidationStepSection = ({ icon: Icon, eyebrow, title, description, children }) => (
  <section className="mobile-card p-4">
    <div className="mb-4 flex items-start gap-3">
      <span className="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-[#eef7ed] text-editorial-charcoal">
        <Icon className="h-5 w-5" />
      </span>
      <div className="min-w-0 flex-1">
        <div className="text-[10px] font-bold uppercase tracking-wide text-[#647260]">{eyebrow}</div>
        <h2 className="text-base font-bold leading-tight text-editorial-charcoal">{title}</h2>
        ...
        <section className="mobile-soft-card p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h1 className="text-lg font-bold leading-tight text-editorial-charcoal">Catat keputusan validasi tanpa modal yang sempit.</h1>
            ...
            {step === 0 ? (
              ...
              >
                <div className="space-y-2">
                  ...
                  >
                    <span className="block text-editorial-charcoal">{selectedFormula?.name || 'Pilih formula'}</span>
