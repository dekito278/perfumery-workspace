      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
              ...
              {statusSteps.map((step, index) => {
                ...
                return (
                  <div key={step} className="min-w-0">
                    <div className={`h-2 rounded-full ${done ? 'bg-editorial-charcoal' : 'bg-stone-200'}`} />
                    <div className={`mt-1 truncate text-[10px] font-bold uppercase ${done ? 'text-editorial-charcoal' : 'text-muted-foreground'}`}>{statusLabels[step]}</div>
                  </div>
                );
              })}
            </div>
        ...
        <section className="mb-5 grid gap-3 lg:grid-cols-[1.2fr_1fr_1fr_1fr]">
          <div className="rounded-2xl border border-editorial-charcoal/10 bg-white p-4 shadow-sm">
            ...
            <h2 className="mt-2 text-xl font-bold text-editorial-charcoal">{nextOperationalTask.title}</h2>
          ...
          <div className="rounded-2xl border border-editorial-charcoal/10 bg-white p-4 shadow-sm">
            ...
            {bespoke ? (
              ...
              <>
                <p className="mt-2 truncate text-sm font-bold text-editorial-charcoal">{order.customerName}</p>
        ...
        <section className="mb-5 rounded-2xl border border-editorial-charcoal/10 bg-white p-4 shadow-sm">
          <div className="grid gap-3 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <div className="text-xs font-bold uppercase text-editorial-charcoal">Panel aksi</div>
        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_380px]">
          <div className="grid gap-5">
            <section className="rounded-2xl border bg-white/90 p-5 shadow-sm">
              <div className="mb-4 flex items-center gap-2 text-xs font-bold uppercase text-editorial-charcoal">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="rounded-2xl bg-[#fbfaf7] p-4">
                  ...
                  {order.customerCode ? <p className="mt-3 w-fit rounded-full bg-editorial-ivory px-3 py-1 text-xs font-bold uppercase text-editorial-charcoal">{order.customerCode}</p> : null}
                </div>
                <div className="rounded-2xl bg-[#fbfaf7] p-4">
                  ...
                  {area ? <p className="mt-2 text-sm font-bold text-editorial-charcoal">{area}</p> : null}
            ...
            {bespoke ? (
              <section className="rounded-2xl border border-editorial-charcoal/10 bg-editorial-ivory p-5 shadow-sm">
                <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                  <div className="flex items-center gap-2 text-xs font-bold uppercase text-editorial-charcoal">
                ...
                <div className="grid gap-3 md:grid-cols-3">
                  <div className="rounded-2xl bg-white px-4 py-3">
                    ...
                    <span className="mt-1 block truncate text-sm font-bold text-editorial-charcoal">{bespokeSummary?.bottle}</span>
                  </div>
                  <div className="rounded-2xl bg-white px-4 py-3 md:col-span-2">
                    ...
                    <span className="mt-1 block truncate text-sm font-bold text-editorial-charcoal">{bespokeSummary?.design}</span>
                  </div>
                </div>
            ...
            <section className="rounded-2xl border bg-white/90 p-5 shadow-sm">
              <div className="mb-4 flex items-center justify-between gap-3">
                ...
                <span className="rounded-full bg-editorial-ivory px-3 py-1 text-xs font-bold uppercase text-editorial-charcoal">{proofTimeline.length} event</span>
              </div>
              {proofTimeline.length ? (
                <div className="grid gap-3">
                  {proofTimeline.map((event) => (
                    <article key={event.id} className="rounded-2xl border border-editorial-charcoal/10 bg-[#fbfaf7] p-3">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        ...
                        <span className="rounded-full bg-white px-2.5 py-1 text-[10px] font-bold uppercase text-editorial-charcoal">Percobaan {event.attempt}</span>
                      </div>
            ...
            <section className="rounded-2xl border bg-white/90 p-5 shadow-sm">
              ...
              <div className="mt-4 rounded-2xl border border-editorial-charcoal/10 bg-[#fbfaf7] p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    ...
                    {order.paymentProofFileName ? (
                      <div className="mt-2 truncate rounded-xl bg-white px-3 py-2 text-sm font-bold text-editorial-charcoal">
                        {order.paymentProofFileName}
                      </div>
                    ) : null}
                ...
                {paymentProofPreviewUrl && !paymentProofIsImage ? (
                  <button type="button" onClick={openPaymentProof} className="mt-4 flex w-full items-center gap-3 rounded-2xl border bg-white px-4 py-3 text-left text-sm font-bold text-editorial-charcoal">
            ...
            <section className="rounded-2xl border bg-white/90 p-5 shadow-sm">
              ...
              <div className="overflow-hidden rounded-2xl border">
                ...
                {voucherSnapshot ? (
                  <div className="grid grid-cols-[1fr_80px_120px] gap-3 border-b bg-editorial-ivory px-4 py-3 text-sm font-semibold last:border-b-0">
                    <span className="min-w-0">
                      <span className="block truncate font-bold text-editorial-charcoal">Voucher {voucherSnapshot.code}</span>
                      <span className="text-xs text-editorial-muted">{voucherSnapshot.discountType || 'discount'} {voucherSnapshot.discountValue || ''}</span>
                    </span>
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-2">
          <section className="rounded-2xl border bg-white/90 p-5 shadow-sm">
            <div className="mb-4 flex items-center justify-between gap-3">
              ...
              <span className="rounded-full bg-editorial-ivory px-3 py-1 text-xs font-bold uppercase text-editorial-charcoal">{auditLogs.length} log</span>
            </div>
                  ...
                  return (
                    <article key={log.id} className={`rounded-2xl p-3 ${important ? 'border border-amber-200 bg-amber-50' : 'bg-[#fbfaf7]'}`}>
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <span className="shrink-0 rounded-full bg-white px-2.5 py-1 text-[10px] font-bold uppercase text-editorial-charcoal">{log.actorEmail || 'system'}</span>
                      </div>
                      {changes.length ? (
                        <div className="mt-3 grid gap-2">
                          {changes.map((change) => {
                            ...
                            return (
                            <div key={change.key} className={`rounded-2xl border bg-white px-3 py-2 ${importantChange ? 'border-amber-200 ring-1 ring-amber-100' : 'border-editorial-charcoal/10'}`}>
                              <div className={`text-[10px] font-bold uppercase ${importantChange ? 'text-amber-800' : 'text-editorial-charcoal'}`}>{change.label}</div>
                              <div className="mt-1 grid gap-2 text-xs font-semibold text-muted-foreground sm:grid-cols-2">
                                ...
                                <span className="min-w-0 rounded-xl bg-editorial-ivory px-2 py-1">Sesudah: <span className="text-[#1f2937]">{change.after}</span></span>
                              </div>
                            </div>
                            );
                          })}
          ...
          <section className="rounded-2xl border bg-white/90 p-5 shadow-sm">
            <div className="mb-4 flex items-center justify-between gap-3">
              ...
              <span className="rounded-full bg-editorial-ivory px-3 py-1 text-xs font-bold uppercase text-editorial-charcoal">{timeline.length} event</span>
            </div>
            <div className="grid gap-3">
              {timeline.map((entry, index) => (
                <div key={`${entry.status}-${entry.at}-${index}`} className="grid grid-cols-[28px_1fr] gap-3">
                  <div className="flex flex-col items-center">
                    <span className="h-3 w-3 rounded-full bg-editorial-charcoal" />
          ...
          <section className="rounded-2xl border bg-white/90 p-5 shadow-sm">
            <div className="mb-4 flex items-center justify-between gap-3">
              ...
              <span className="rounded-full bg-editorial-ivory px-3 py-1 text-xs font-bold uppercase text-editorial-charcoal">{paymentLogs.length} log</span>
            </div>
            {paymentLogs.length ? (
              <div className="grid gap-3">
                {paymentLogs.map((log) => (
